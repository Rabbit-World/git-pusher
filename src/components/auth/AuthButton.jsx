...
import { signInWithGithub, signOutUser } from '../../services/auth';
  ...
  return (
    <button 
      ...
      className={`px-4 py-2 rounded-md flex items-center justify-center ${
        user 
          ? 'bg-github-darker text-github-text border border-github-border' 
          : 'bg-github-btn hover:bg-github-btn-hover text-white'
      } ${(authLoading || isLoading) ? 'opacity-70 cursor-not-allowed' : ''}`}
    >
